...
for rep in [3]:
    ...
    for numHubs in [80]:
        ...
        incumbent = pd.read_csv('result_arr_constrained_I3405_J170_lambda100percent_24hours/arr_constrained_pnr_origin%s_I%s_J%s_p%s_rep%s_lambda%spercent.csv'%(numOrigins,numOrigins*numDestins,numAlternatives,numHubs,rep,int(lambdaBase * 100)))
